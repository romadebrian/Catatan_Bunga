...
import com.roma.catatanbunga.Adapter.NoteAdapter;
import com.roma.catatanbunga.Db.NoteHelper;
import com.roma.catatanbunga.Entity.Note;

import java.util.ArrayList;
import java.util.LinkedList;

import static com.roma.catatanbunga.FormAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color=\"#8c5b4d\">" + getString(R.string.titleX) + "</font>"));
